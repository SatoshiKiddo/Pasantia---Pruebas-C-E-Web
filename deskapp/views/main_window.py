...
"}")
        ...
        self.CheckDependencyAle = QCheckBox(Form)
        self.CheckDependencyAle.setObjectName(u"CheckRoute")
        self.CheckDependencyAle.setGeometry(QRect(410, 660, 131, 20))
...
"}")
        ...
        icon4 = QIcon()
        icon4.addFile(u"./deskapp/assets/Iconos/check.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.CheckDependencyAle.setText(QCoreApplication.translate("Form", u"Excluir Fijas", None))
